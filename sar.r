...
## d matrice n x 4,
## la riga i_esima contiene le etichette dei 4 punti più vicino al punto i
...
## yo non è noto (è proprio quello che si deve stimare)
## => l'unica stima dei fitted che si può ottenere con le informazioni
## del nuovo dataset:
## yh.o = Zo bh
...
## più vicini all'i_esimo individuo del nuovo dataset

## in questo modo i nuovi dati sono supposti dipendere dai 4 individui più
...
## iniziale X più vicini a i (distanza euclidea valutata sulle coord. lat o long.)
...
## per ogni riga i, D[i,j] = 0.25 se j è il valore corrispondente ad uno
...
## è quindi in accordo con il modello che la sar dia delle cattive previsioni
